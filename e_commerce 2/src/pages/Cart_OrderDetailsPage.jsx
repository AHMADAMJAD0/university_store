    ...
    return (
      <div>
        ...
        <div
          ...
          style={{ height: "90vh" }}
        >
          <div className="flex flex-col lg:flex-row gap-10 items-center justify-center "style={{width:"95%"}}>
            {/* Image Section */}
            <div
            ...
            <div
              className="bg-white px-6 py-10 rounded-lg shadow-md w-full lg:w-2/3 animate-popUp"
            >
              <h2 className="text-4xl font-bold mb-6 animate-slideInRight"style={{color: "rgb(146, 73, 146)"}}>
                {product.name}
              </h2>
              ...
              <p className="text-gray-700 text-lg mb-3">
                ...
                <p className="text-gray-700 text-lg mt-3">
                  <strong>Total Price:</strong> {(product.price * location.state?.quantity).toFixed(2)}
                </p>
            </div>
          </div>
          ...
          <div className="flex justify-center gap-4 mt-6 animate-popUp">
            {product.images.map((img, index) => (
              <img
                ...
                className={`w-16 h-16 object-cover rounded-md cursor-pointer border-2 transition-all duration-300 transform ${index === selectedImage
  ...
  >
    <thead>
      <tr style={{ background: "#d98780" }}>
        <th className="p-4 text-left font-semibold text-gray-800">Product</th>
        <th className="p-4 text-left font-semibold text-gray-800">Size</th>
        <th className="p-4 text-left font-semibold text-gray-800">Quantity</th>
        <th className="p-4 text-left font-semibold text-gray-800">Price</th>
        <th className="p-4 text-left font-semibold text-gray-800">Total</th>
      </tr>
    </thead>
    <tbody>

...
import { HiOutlineCreditCard, HiOutlineCalendar, HiOutlineLockClosed, HiOutlineShieldCheck } from "react-icons/hi"; // React Icons
...
const validateField = (field, type) => {
  switch (type) {
    case "email":
      return /^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.[a-zA-Z]{0,}$/.test(field);
    case "phone":
      return /^[0-9]+$/.test(field) && field.length >= 10 && field.length <= 12;
    case "zipCode":
      return /^[0-9 ]{0,}$/.test(field);
...
const EditProfilePage = ({ loggedInUser }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!validateField(updatedUser.billingCardNumber, "billingCardNumber", true)) {
    ...
    if (password || confirmPassword) {
      ...
      if (!validateField(confirmPassword, "password", true)) { // Pass isRequired flag
    ...
    <div>
      ...
      <div className="full-body bg-gray-50 min-h-screen flex justify-center items-center ">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-6xl bg-gray-200 shadow-lg rounded-lg p-8 pb-10">
          <h1 className="text-2xl font-bold text-center mt-8 mb-6" style={{ color: "rgb(146, 73, 146)", fontWeight: "700", fontSize: "30px" }}>Edit Your Profile</h1>
            ...
            <div className="billing-info mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pl-10">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        const formattedValue = e.target.value
                          .replace(/\D/g, "")
                          .replace(/(\d{4})(?=\d)/g, "$1 ");
                        handleChange({ target: { name: "billingCardNumber", value: formattedValue } });
                      }}
                      className="w-full pl-4 py-2 border-none focus:outline-none"
                    />
                  </div>
                  {validationErrors.billingCardNumber && (
                  <p className="text-red-500 text-sm mt-1">{validationErrors.billingCardNumber}</p>
                )}
                </div>
                  ...
                  <div className="flex items-center border-b-2 mt-2 pl-4">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        handleChange({ target: { name: "billingExpiration", value: formattedValue } });
                      }}
                      className="w-full pl-4 py-2 border-none focus:outline-none"
                    />
                  </div>
                  {validationErrors.billingExpiration && (
                  <p className="text-red-500 text-sm mt-1">{validationErrors.billingExpiration}</p>
                )}
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="text-red-500 text-sm mt-1">{validationErrors.billingCVC}</p>
                )}
                </div>
